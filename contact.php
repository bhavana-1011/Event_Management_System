    ...
    <body>
        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                ...
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Bhavana</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: bhavanajangid1011@gmail.com<br>
    
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 9353744887
                    </p>
                </div>
            </div>
